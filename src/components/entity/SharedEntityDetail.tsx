...
interface SharedEntityDetailProps {
  id: string | undefined;
  entityType: "client" | "competitor" | "prospect" | "primary";
  backRoute: string;
  notFoundText: string;
}

export function SharedEntityDetail({ id, entityType, backRoute, notFoundText }: SharedEntityDetailProps) {
  const navigate = useNavigate();
  const { isLoading, data, reload } = useEntityDetail(entityType, id);
